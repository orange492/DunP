...
void monsterManager::dexSetting()
{
	...
	dexSet(2, IMAGEMANAGER->findImage("a2"), "이상해꽃", GRASS, PointMake(3, 3), 7,18, 200, 3, 1, 0.8,15,30, false, true, true, true, true);
	dexSet(3, IMAGEMANAGER->findImage("a3"), "파이리", FIRE, PointMake(1, 2), 10,27, 100, 1, 1.1, 0.8,5,10, true, true, true, true, true);
	dexSet(4, IMAGEMANAGER->findImage("a4"), "리자드", FIRE, PointMake(2, 2), 11,46, 150, 2, 1.2, 0.8,10,20, true, true, true, true, true);
	dexSet(5, IMAGEMANAGER->findImage("a5"), "리자몽", FIRE, PointMake(3, 3), 6,36, 200, 3, 0.8, 0.8,15,30, false, true, true, true, true);
	dexSet(6, IMAGEMANAGER->findImage("a6"), "꼬부기", WATER, PointMake(1, 2), 12,17, 100, 1, 1, 0.8,5,10, true, true, true, true, true);
	dexSet(7, IMAGEMANAGER->findImage("a7"), "어니부기", WATER, PointMake(2, 2), 13,18, 150, 2, 0.9, 0.8,10,20, true, true, true, true, true);
	dexSet(8, IMAGEMANAGER->findImage("a8"), "거북왕", WATER, PointMake(3, 3), 10,30, 200, 3, 0.8, 0.8,15,30, false, true, true, true, true);
	dexSet(9, IMAGEMANAGER->findImage("a9"), "스라크", GRASS, PointMake(2, 2), 11,15, 100, 2, 1.1, 0.8,5,15, true, true, true, true, true);
	dexSet(10, IMAGEMANAGER->findImage("a10"), "핫산", GRASS, PointMake(3, 3), 10,30, 150, 3, 1.2, 0.8,10,25, false, true, true, true, true);
	dexSet(11, IMAGEMANAGER->findImage("a11"), "식스테일", FIRE, PointMake(2, 2), 9,18, 120, 1, 1.3, 0.8,5,15, true, true, true, true, true);
	dexSet(12, IMAGEMANAGER->findImage("a12"), "나인테일", FIRE, PointMake(3, 3), 9,9, 170, 2, 1.2, 0.8,10,25, false, true, true, true, true);
	dexSet(13, IMAGEMANAGER->findImage("a13"), "셀러", WATER, PointMake(2, 2), 11,44, 150, 1, 0.8, 0.8,5,15, true, true, true, true, true);
	dexSet(14, IMAGEMANAGER->findImage("a14"), "파르셀", WATER, PointMake(3, 3), 10,18, 200, 2, 0.7, 0.8,10,25, false, true, true, true, true);
}
